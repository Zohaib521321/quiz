...
class physics_show extends StatefulWidget {
  const physics_show({Key? key}) : super(key: key);

  @override
  State<physics_show> createState() => _physics_showState();
}

class _physics_showState extends State<physics_show> {
  int num=1;
  int qno=1;
          ...
          child: StreamBuilder(
              ...
              builder: (context,AsyncSnapshot<QuerySnapshot>snapshot){
                ...
                for (int i = 0; i<=min(2000,snapshot.data!.docs.length); i++) {
                  ...
                  if(randomIndexes.length == 12) break;
                }
