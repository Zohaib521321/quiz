...
class general_knowledge_show extends StatefulWidget {
  const general_knowledge_show({Key? key}) : super(key: key);

  @override
  State<general_knowledge_show> createState() => _general_knowledge_showState();
}

class _general_knowledge_showState extends State<general_knowledge_show> {
  int num=1;
  int qno=1;
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child: StreamBuilder(
              stream:FirebaseFirestore.instance.collection("general_knowledge").snapshots(),
