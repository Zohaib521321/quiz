...
class chemistry_show extends StatefulWidget {
  const chemistry_show({Key? key}) : super(key: key);

  @override
  State<chemistry_show> createState() => _chemistry_showState();
}

class _chemistry_showState extends State<chemistry_show> {
  int num=1;
  int qno=1;
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child: StreamBuilder(
              stream:FirebaseFirestore.instance.collection("chemistry").snapshots(),
