...
class english_show extends StatefulWidget {
  const english_show({Key? key}) : super(key: key);

  @override
  State<english_show> createState() => _english_showState();
}

class _english_showState extends State<english_show> {
  int num=1;
  int qno=1;
