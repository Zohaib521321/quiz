...
class general_add extends StatefulWidget {
  const general_add({Key? key}) : super(key: key);

  @override
  State<general_add> createState() => _general_addState();
}

class _general_addState extends State<general_add> {
                  ...
                  Card(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(onPressed:(){
                        ...
                        final ref=FirebaseFirestore.instance.collection("general_knowledge");
