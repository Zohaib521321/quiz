...
class physics_add extends StatefulWidget {
  const physics_add({Key? key}) : super(key: key);

  @override
  State<physics_add> createState() => _physics_addState();
}

class _physics_addState extends State<physics_add> {
                  ...
                  Card(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(onPressed:(){
                        ...
                        final ref=FirebaseFirestore.instance.collection("physics");
