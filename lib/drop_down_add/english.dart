...
class english_add extends StatefulWidget {
  const english_add({Key? key}) : super(key: key);

  @override
  State<english_add> createState() => _english_addState();
}

class _english_addState extends State<english_add> {
                  ...
                  Card(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(onPressed:(){
                        ...
                        final ref=FirebaseFirestore.instance.collection("English");
