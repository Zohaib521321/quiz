...
class computer_add extends StatefulWidget {
  const computer_add({Key? key}) : super(key: key);

  @override
  State<computer_add> createState() => _computer_addState();
}

class _computer_addState extends State<computer_add> {
                  ...
                  Card(
                    ...
                    child: Container(
                      ...
                      child: ElevatedButton(onPressed:(){
                        ...
                        final ref=FirebaseFirestore.instance.collection("computer");
